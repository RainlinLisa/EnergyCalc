<template>
		...
		<form>
			<div class="control-group controls">
				...
				<div class="row">
					...
					<div class="span2"><input class="input-small text-right" type="text" v-model.number="lifeTimeFilam" v-on:keypress="onlyFloat"></div>
	...
	<tableCalc-component></tableCalc-component>
	<tableCalc-component></tableCalc-component>
	<tableCalc-component></tableCalc-component>	
</template>
